...
export const metadata: Metadata = {
  title: "Obyte Friends (Old) — Frequently asked questions",
      ...
      <Faq.Container>
        ...
        <Faq.Item>
          ...
          <Faq.Content>
            ...
            <p>
              Percentage-wise, they are 1/10th of the initial rewards, that is {toLocalString(appConfig.initialRewardsVariables.locked_reward_share * appConfig.initialParamsVariables.followup_reward_share * 100)}% to the locked balance and {toLocalString(appConfig.initialRewardsVariables.liquid_reward_share * appConfig.initialParamsVariables.followup_reward_share * 100)}% in liquid {symbol}. However, they are applied to your new balance, which is likely much higher than the balance you had when you became friends.
            </p>
