...
import { getNameByKey } from "../utils/getNameByKey";
...
export const GovernableItemHeader = <K extends keyof AgentParams>({ name, currentValue, frdToken }: GovernableItemHeaderProps<K>) => (
