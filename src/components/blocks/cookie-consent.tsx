  ...
  (
        ...
        <div {...commonWrapperProps}>
          <Card className="m-3 shadow-lg">
            ...
            <CardContent className="space-y-2">
              ...
              <a
                href={learnMoreHref}
                className="text-xs underline text-primary underline-offset-4 hover:no-underline"
              >
                Learn more
              </a>
            </CardContent>
    ...
    if (variant === "small") {
      return (
        <div {...commonWrapperProps}>
          <Card className="m-3 shadow-lg">
            <CardHeader className="flex flex-row items-center justify-between h-0 px-4 pb-2 space-y-0">
    ...
    if (variant === "mini") {
      return (
        <div {...commonWrapperProps}>
          <Card className="p-0 py-3 mx-3 shadow-lg">
            <CardContent className="sm:flex grid items-center  gap-4 p-0 px-3.5">
